...
$\mathcal{N}(0,1)$ priors; the added post-2008 effect uses the same prior.
...
\begin{itemize}
    ...
    employment rate shows the strongest positive association with net migration
    ($\hat{\beta}=+0.250$), followed by population-density growth
    ($\hat{\beta}=+0.074$).
